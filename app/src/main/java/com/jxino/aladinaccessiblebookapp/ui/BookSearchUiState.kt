...
sealed class BookSearchUiState {
    ...
    data object InternetUnavailable : BookSearchUiState()
    data class AladinApiUnavailable(val message: String) : BookSearchUiState()
    data class InvalidApiResponse(val message: String) : BookSearchUiState()
